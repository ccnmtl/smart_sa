...
urlpatterns = patterns('',
        ...
        (r'^session/(?P<session_id>\d+)/visit/$', 'smart_sa.intervention.views.log_session_visit'),
        ...
        (r'^activity/(?P<activity_id>\d+)/visit/$', 'smart_sa.intervention.views.log_activity_visit'),
