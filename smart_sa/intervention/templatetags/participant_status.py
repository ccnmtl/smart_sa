...
def get_barrier_title(title):
    ...
    titles = {
        u'happy': u'I feel so well now that I do not need to take the '
        'medicines.',
        u'other_treatments': u'There are other treatments that I think work '
        'better than ARVs.',
        u'peopletellmenotto': u'Other people tell me not to take the ARVs.',
        u'disability_grant': u'If I get healthy, I might lose my disability '
        'grant.',
        u'cantgettoclinic': u'It is difficult to get to the clinic.',
        u'angrynurse': u'If I don\'t take my pills, I am afraid to come back '
        'to the clinic.',
        u'forgetful': u'Sometimes I forget to take my pills.',
        u'nonsense': u'Sometimes my providers don\'t make much sense.',
        u'sickwithcold': u'I stop taking my medication when I have a cold, '
        'or flu, or other problems.',
        ...
        u'hopeless': u'When I feel sad or hopeless or too stressed out, '
        'I don\'t care about taking my ARVs.',
        ...
        u'otherpatients': u'Other patients at the clinic might gossip about '
        'my HIV status.',
    }
