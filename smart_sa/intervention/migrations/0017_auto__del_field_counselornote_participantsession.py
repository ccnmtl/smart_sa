...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CounselorNote.participantsession'
        db.delete_column('intervention_counselornote', 'participantsession_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'CounselorNote.participantsession'
        raise RuntimeError("Cannot reverse this migration. 'CounselorNote.participantsession' and its values cannot be restored.")
