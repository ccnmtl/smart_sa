...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.buddy_name'
        db.add_column('intervention_participant', 'buddy_name', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Adding field 'Activity.collect_buddy_name'
        db.add_column('intervention_activity', 'collect_buddy_name', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.buddy_name'
        db.delete_column('intervention_participant', 'buddy_name')

        # Deleting field 'Activity.collect_buddy_name'
        db.delete_column('intervention_activity', 'collect_buddy_name')
