...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Intervention.intervention_id'
        db.add_column('intervention_intervention', 'intervention_id', self.gf('django.db.models.fields.CharField')(default='1', max_length=8), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Intervention.intervention_id'
        db.delete_column('intervention_intervention', 'intervention_id')
