...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.reasons_for_returning'
        db.add_column('intervention_participant', 'reasons_for_returning', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Activity.collect_reasons_for_returning'
        db.add_column('intervention_activity', 'collect_reasons_for_returning', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.reasons_for_returning'
        db.delete_column('intervention_participant', 'reasons_for_returning')

        # Deleting field 'Activity.collect_reasons_for_returning'
        db.delete_column('intervention_activity', 'collect_reasons_for_returning')
