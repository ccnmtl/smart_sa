...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('intervention_deployment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='Clinic', max_length=256)),
        ))
        db.send_create_signal('intervention', ['Deployment'])


    def backwards(self, orm):
        
        # Deleting model 'Deployment'
        db.delete_table('intervention_deployment')
