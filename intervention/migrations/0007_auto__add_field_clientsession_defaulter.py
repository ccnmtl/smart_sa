...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClientSession.defaulter'
        db.add_column('intervention_clientsession', 'defaulter', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClientSession.defaulter'
        db.delete_column('intervention_clientsession', 'defaulter')
