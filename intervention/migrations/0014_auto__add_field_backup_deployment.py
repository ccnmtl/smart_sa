...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Backup.deployment'
        db.add_column('intervention_backup', 'deployment', self.gf('django.db.models.fields.CharField')(default='Clinic', max_length=256), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Backup.deployment'
        db.delete_column('intervention_backup', 'deployment')
