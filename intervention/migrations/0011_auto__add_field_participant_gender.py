...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('intervention_participant', 'gender', self.gf('django.db.models.fields.CharField')(default='male', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.gender'
        db.delete_column('intervention_participant', 'gender')
