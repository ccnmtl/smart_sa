...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.patient_id'
        db.add_column('intervention_participant', 'patient_id', self.gf('django.db.models.fields.CharField')(default='', max_length=256), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.patient_id'
        db.delete_column('intervention_participant', 'patient_id')
