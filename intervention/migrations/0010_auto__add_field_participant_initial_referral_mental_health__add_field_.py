...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.initial_referral_mental_health'
        db.add_column('intervention_participant', 'initial_referral_mental_health', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participant.initial_referral_alcohol'
        db.add_column('intervention_participant', 'initial_referral_alcohol', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participant.initial_referral_drug_use'
        db.add_column('intervention_participant', 'initial_referral_drug_use', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participant.initial_referral_other'
        db.add_column('intervention_participant', 'initial_referral_other', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participant.initial_referral_notes'
        db.add_column('intervention_participant', 'initial_referral_notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Participant.defaulter_referral_mental_health'
        db.add_column('intervention_participant', 'defaulter_referral_mental_health', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participant.defaulter_referral_alcohol'
        db.add_column('intervention_participant', 'defaulter_referral_alcohol', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participant.defaulter_referral_drugs'
        db.add_column('intervention_participant', 'defaulter_referral_drugs', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participant.defaulter_referral_other'
        db.add_column('intervention_participant', 'defaulter_referral_other', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participant.defaulter_referral_notes'
        db.add_column('intervention_participant', 'defaulter_referral_notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Activity.collect_referral_info'
        db.add_column('intervention_activity', 'collect_referral_info', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.initial_referral_mental_health'
        db.delete_column('intervention_participant', 'initial_referral_mental_health')

        # Deleting field 'Participant.initial_referral_alcohol'
        db.delete_column('intervention_participant', 'initial_referral_alcohol')

        # Deleting field 'Participant.initial_referral_drug_use'
        db.delete_column('intervention_participant', 'initial_referral_drug_use')

        # Deleting field 'Participant.initial_referral_other'
        db.delete_column('intervention_participant', 'initial_referral_other')

        # Deleting field 'Participant.initial_referral_notes'
        db.delete_column('intervention_participant', 'initial_referral_notes')

        # Deleting field 'Participant.defaulter_referral_mental_health'
        db.delete_column('intervention_participant', 'defaulter_referral_mental_health')

        # Deleting field 'Participant.defaulter_referral_alcohol'
        db.delete_column('intervention_participant', 'defaulter_referral_alcohol')

        # Deleting field 'Participant.defaulter_referral_drugs'
        db.delete_column('intervention_participant', 'defaulter_referral_drugs')

        # Deleting field 'Participant.defaulter_referral_other'
        db.delete_column('intervention_participant', 'defaulter_referral_other')

        # Deleting field 'Participant.defaulter_referral_notes'
        db.delete_column('intervention_participant', 'defaulter_referral_notes')

        # Deleting field 'Activity.collect_referral_info'
        db.delete_column('intervention_activity', 'collect_referral_info')
