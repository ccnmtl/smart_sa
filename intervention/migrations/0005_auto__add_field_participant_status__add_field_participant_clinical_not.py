...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.status'
        db.add_column('intervention_participant', 'status', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Participant.clinical_notes'
        db.add_column('intervention_participant', 'clinical_notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Changing field 'Instruction.image'
        db.alter_column('intervention_instruction', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Participant.status'
        db.delete_column('intervention_participant', 'status')

        # Deleting field 'Participant.clinical_notes'
        db.delete_column('intervention_participant', 'clinical_notes')

        # Changing field 'Instruction.image'
        db.alter_column('intervention_instruction', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
