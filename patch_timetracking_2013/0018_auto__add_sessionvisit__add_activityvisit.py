...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SessionVisit'
        db.create_table('intervention_sessionvisit', (
            ...
            ('logged', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('intervention', ['SessionVisit'])

        # Adding model 'ActivityVisit'
        db.create_table('intervention_activityvisit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['intervention.Participant'])),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['intervention.Activity'])),
            ('logged', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('intervention', ['ActivityVisit'])


    def backwards(self, orm):
        
        # Deleting model 'SessionVisit'
        db.delete_table('intervention_sessionvisit')

        # Deleting model 'ActivityVisit'
        db.delete_table('intervention_activityvisit')
    ...
    models = {
        ...
        'intervention.activityvisit': {
            'Meta': {'object_name': 'ActivityVisit'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['intervention.Activity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logged': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'intervention.sessionvisit': {
            'Meta': {'object_name': 'SessionVisit'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logged': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['intervention.Participant']"}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['intervention.ClientSession']"})
