...
Slider.prototype.pos = function(v) {
    ...
    x = this.start_offset.x +  this.background_position.x + this.unit.x * v
    y = this.start_offset.y +  this.background_position.y + this.unit.y * v
    return [x , y];
}
...
Slider.prototype.getfraction = function() {
    ...
    diff = this.max_value - this.min_value;
